...
var inject = function(target, source, props) {
...
module.exports.createTransport = function(config) {
  ...
  var propsCheck = propValidateCheck(config, props)
  if (propsCheck.length) {
    warn(propsCheck.join(','))
  }
  param = {
